        ...
        <div className="pt-[8rem] max-w-[1228px] w-full ">
          ...
          <NavBar>
            <div className="flex max-w-[29rem] w-full justify-between my-8 py-4 text-[#2B6CB0] font-semibold ">
              <Link passHref={true} href={`/g/${guildId}/`}>
                <p>#Issue</p>
              </Link>
              <Link passHref={true} href={`/g/${guildId}/stage`}>
                <p>Stage</p>
              </Link>
              <Link passHref={true} href={`/g/${guildId}/scrap-town`}>
                <p>Scrap town</p>
              </Link>
              <Link passHref={true} href={`/g/${guildId}/market`}>
                <p>Market</p>
              </Link>
              <Link passHref={true} href={`/g/${guildId}/guild`}>
                <p>Guild</p>
              </Link>
            </div>
