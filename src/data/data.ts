export const featuredGuilds = [
  {
    ...
    name: "MIDJOURNEY",
    bio: "the official server for midjourney, a text to image AI where your imagination is the only limit",
    id: "001",
  },
  {
    cover:
...
export const PopularIssues = [
  {
    ...
    name: "Midjourney",
    issue: "MIDJOURNEY #1",
    description: "Our Equilibrum collection promotes calm and peace",
    id: "001",
  },
  {
    cover:
